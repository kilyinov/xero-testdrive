...
@RestController
@RequestMapping("/api/comm-unity-library-kafka")
public class CommUnityLibraryKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CommUnityLibraryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CommUnityLibraryKafkaResource(KafkaProperties kafkaProperties) {
